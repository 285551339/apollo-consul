...
import com.ctrip.framework.apollo.common.utils.DateUtils;
...
public class ConsulController {
    ...
    public Object services() {
        return discoveryClient.getInstances("apollo-configservice");
    }
    ...
    public Object discover() {
        return loadBalancer.choose("apollo-configservice").getUri().toString();
    }
